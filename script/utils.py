...
def load_data(data_class_0,data_class_1,data_length):
    """
    Load data from the specified files.

    Args:
        data_class_0 (str): The path to the modified data file.
        data_class_1 (str): The path to the unmodified data file.
    ...
    """
    X,Y=[],[]
    for i,file in enumerate([data_class_0,data_class_1]):
        with open(file) as f:
            count=0
            for line in f:
...
def load_data_3_class(data_class_0,data_class_1,data_class_2,data_length):
    """
    Load data from the specified files.

    Args:
        data_class_0 (str): The path to the class 0 data file.
        data_class_1 (str): The path to the class 1 data file
        data_class_2 (str): The path to the class 2 data file
        data_length (int): The desired length of the data.
    ...
    """
    X,Y=[],[]
    for i,file in enumerate([data_class_0,data_class_1,data_class_2]):
        with open(file) as f:
            count=0
            for line in f:
