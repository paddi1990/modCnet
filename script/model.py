...
class modCnet_3_classes(nn.Module):
    """
    TandemMod model。
    ...
    def __init__(self,num_classes=3,vocab_zie=5, embedding_size=4,seq_len=5):
        super(modCnet_3_classes,self).__init__()
...
class modCnet_eventlevel_features(nn.Module):
    """
    TandemMod model。
    ...
    """
    def __init__(self,num_classes=2,vocab_zie=5, embedding_size=4,seq_len=5):
        super(modCnet_eventlevel_features,self).__init__()
...
class modCnet_currentlevel_features(nn.Module):
    """
    TandemMod model。
    ...
    """
    def __init__(self,num_classes=2,vocab_zie=5, embedding_size=4,seq_len=5):
        super(modCnet_currentlevel_features,self).__init__()
